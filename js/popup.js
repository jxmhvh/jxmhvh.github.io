...
function popup1() {
    CreativaPopup.create('Feel free to DM me Naxxly#0001 &#10084', 'Discord');
}
...
function popup13() {
    CreativaPopup.create(' <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">Naxxly#0001</font> &#10084<br> <font style="color: #696969; font-size: smaller;">   <a href="" style="color: #ADD8E6;"></a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("Naxxly#0001");
    setTimeout(function() {
